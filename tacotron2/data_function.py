...
class TextMelLoader(torch.utils.data.Dataset):
    ...
    def get_mel_text_speaker_pair(self, audiopath_text_speaker):
        ...
        audiopath, text, speaker_id = audiopath_text_speaker[0], audiopath_text_speaker[1], audiopath_text_speaker[2]
...
class TextMelCollate():
    ...
    def __call__(self, batch):
        ...
        PARAMS
        ------
        batch: [text_normalized, mel_normalized, len_text, speaker_id]
        """
